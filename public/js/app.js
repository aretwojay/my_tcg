...
var ArenaController = function (_Controller) {
    ...
    function ArenaController() {
        ...
        _this.game = _factory2.default.get('game', {
            'up': _factory2.default.get('player', { type: 'computer' }),
            'down': _factory2.default.get('player', { type: 'human' })
        });

        _this.up.mHand.setState({ life: _this.game["up"].life });
        _this.down.mHand.setState({ life: _this.game["down"].life });

        _this.game["down"].deck.shuffle();
        _this.game["up"].deck.shuffle();

        _this.$dom.find('.life').html("PV " + _this.game['up']['life']);
    ...
    _createClass(ArenaController, [{
        ...
        value: function onClickBoard(card) {
            ...
            if (!secondClick) {
                ...
                console.log("card", card);
                var opponent = side === "down" ? "up" : "down";
                var activeCard = self[side].mBoard.mActiveCard;
                this.trigger('targetCard', card);
                var target = new _pawn2.default(card.mState.life, card.mState.strength, card.mState.def);
                ...
                if (card.mState.life <= 0) {
                    ...
                    setTimeout(function () {
                        ...
                        var cardCemetary = self.game[opponent].board.removeCard(card.mState.position);
                ...
                if (activeCard.mState.life <= 0) {
                    ...
                    setTimeout(function () {
                        ...
                        var cardCemetary = self.game[side].board.removeCard(activeCard.mState.position);
...
},{"../models/factory":348,"../models/pawn":351,"./dom":339,"./side":341}],335:[function(require,module,exports){
'use strict';
...
},{"./dom":339}],336:[function(require,module,exports){
'use strict';
...
var CardController = function (_Controller) {
    ...
    function CardController(parent) {
        ...
        _this.$dom.append('<div></div>').find('div:first-child').addClass('card-front').html('<div class=\'stats\'></div>');
...
},{"./dom":339}],337:[function(require,module,exports){
'use strict';
...
},{"./dom":339}],338:[function(require,module,exports){
'use strict';
...
},{"../models/factory":348,"./card":336,"./dom":339}],339:[function(require,module,exports){
'use strict';
...
exports.default = Dom;
},{"../eventManager":342,"jquery-browserify":331}],340:[function(require,module,exports){
'use strict';
...
},{"./dom":339}],341:[function(require,module,exports){
'use strict';
...
var SideController = function (_Controller) {
    ...
    function SideController(selector, parent) {
        ...
        _this.parent.on('discardCard', _this.fwdToChild.bind(_this, 'discardCard', 'onDiscardCard'));
...
},{"./board":335,"./cemetary":337,"./deck":338,"./dom":339,"./hand":340}],342:[function(require,module,exports){
"use strict";
...
},{"./controllers/arena":334,"babel-polyfill":1}],344:[function(require,module,exports){
"use strict";
...
},{"./hand":350}],345:[function(require,module,exports){
"use strict";
...
},{"./deck":347}],346:[function(require,module,exports){
'use strict';
...
},{"./board":344,"./cemetary":345,"./deck":347,"./game":349,"./hand":350,"./pawn":351,"./player":352}],347:[function(require,module,exports){
"use strict";
    ...
    _createClass(Deck, [{
        ...
        value: function shuffle() {
            var j = void 0,
                x = void 0,
                index = void 0;
            var initalCards = JSON.stringify(this.cards);
            ...
            if (initalCards !== JSON.stringify(this.cards)) return true;
            return false;
        }
    }, {
        key: "insertAt",
        value: function insertAt(card) {
...
},{"./config":346,"jquery":332}],349:[function(require,module,exports){
"use strict";
...
var Game = function (_EventManager) {
    ...
    _createClass(Game, [{
        ...
        key: "proxy",
        value: function proxy(side, action) {
...
},{"../eventManager":342}],350:[function(require,module,exports){
"use strict";
...
var Hand = function () {
    ...
    _createClass(Hand, [{
        ...
        value: function addCard(card) {
            if (this.cards.length < this.limit) return !!this.cards.push(card);
            return false;
        }
    }, {
        key: "removeCard",
...
},{"../eventManager":342}],352:[function(require,module,exports){
'use strict';
...
var Player = function (_Pawn) {
    ...
    function Player(config) {
        ...
        var _this = _possibleConstructorReturn(this, (Player.__proto__ || Object.getPrototypeOf(Player)).call(this, 100, 0, 0));
    ...
    _createClass(Player, [{
        key: 'shuffle',
        value: function shuffle() {
            var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "deck";
        ...
        value: function playCard(position) {
            var card = this.hand.removeCard(position);
            if (card) {
        ...
        value: function attack(position, target) {
            var card = this.board.cards[position];
            console.log("position", position);
            console.log("card", card);
            if (target instanceof _pawn2.default && card.life && card.strength && card.def) {
                var pawn = new _pawn2.default(card.life, card.strength, card.def);
